          ...
          <div class="span12">
						<div class="headnav">
							<?php
								...
								if(isset($_SESSION['amka'])){
									$ulg = $_SESSION['amka'];
									echo <<<_END
										<form method="post" action="ergodoths_thlergasia.php">
										ΑΜΚΑ: $ulg &nbsp
            ...
            <div id="mySignup" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="ergodoths_thlergasia.php">
                        ...
                        <li class="dropdown active"><a href="#">ΚΟΡΩΝΟΪΟΣ <i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            ...
                            <li><a href="ergodoths_sumptwmata.php">ΕΡΓΑΖΟΜΕΝΟΣ ΜΕ ΣΥΜΠΤΩΜΑΤΑ</a></li>
														<li class="active"><a href="ergodoths_thlergasia.php">ΤΗΛΕΡΓΑΣΙΑ</a></li>
      ...
      <div class="container">
		...
		<section class="content" id="dhlwsh">
			<div class="row">
				<div class="span3">
					<div class="text-center">
						...
						<div id="thlergasia" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mycompcreationLabel" aria-hidden="true">
							...
							<div class="modal-body">
							<form class="form-horizontal" method="post" action="ergodoths_thlergasia.php#dhlwsh">
								<div class="control-group">
				...
				<div class="span9">
					<img width="100%" height="100%" src="img/symptoms/thlergasia.jpg" title="Εργασία από το σπίτι" alt="Εικόνα εργαζόμενου από το σπίτι.">
				</div>
			</div>
		</section>
            ...
            <div class="big-cta">
              <div class="cta-text">
								<span class="pullquote-left">
									<h6>Είναι μια νέα <strong>μορφή εργασίας</strong> κατά την οποία οι εργαζόμενοι μπορούν να εργάζονται από <strong>απόσταση</strong>!
            ...
            <div class="big-cta">
              <div class="cta-text">
								<span class="pullquote-left margintop10">
									...
									Αποφεύγεται η πρόσωπο με πρόσωπο <strong>επαφή</strong> των εργαζομένων και η καθημερινή τους <strong>μετακίνηση</strong>.
									Είναι σαφές ότι όσοι εργάζονται από το σπίτι, είναι λιγότερο πιθανό να έρθουν σε επαφή με τον <strong>κορωνοϊό</strong>.
								...
								<span class="pullquote-right">
									<h6>Ως εργοδότες, καλούμαστε να επιδείξουμε <strong>υπευθυνότητα</strong> και να εφαρμόσουμε την τηλεργασία στο μέγιστο βαθμό.
									Η προστασία της <strong>υγείας</strong> δεν είναι το μόνο όφελος, βοηθά επίσης στην εξοικονόμηση <strong>χρόνου</strong> και <strong>χρήματος</strong>.
									Μόνο ο <strong>εργοδότης</strong> έχει την δυνατότητα να <strong>δηλώνει</strong> τους εργαζόμενους που θα απασχολούνται με τηλεργασία, αλλά και να κάνει <strong>άρση</strong> αυτής ανά πάσα στιγμή.
									Δώστε της μια ευκαιρία και δεν θα το μετανιώσετε!</h6>
								</span>
							</div>
            </div>
          </div>
