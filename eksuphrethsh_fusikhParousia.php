  ...
  <div id="wrapper">
                  ...
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="eksuphrethsh_fusikhParousia.php">ΦΥΣΙΚΗ ΠΑΡΟΥΣΙΑ</a></li>
    ...
    <!-- end header -->
            ...
            <div class="big-cta">
              <div class="cta-text">
								<span class="pullquote-left">
									<h6>Προτού αποφασίσετε να εξυπηρετηθείτε με <strong>φυσική παρουσία</strong>, σας συστήνουμε να δοκιμάσετε την <a href="eksuphrethsh_hlektronika.php">ηλεκτρονική</a> μας εξυπηρέτηση.
								...
								Κατόπιν <strong><a href="#rantevou">ραντεβού</a></strong> μπορείτε να εξυπηρετηθείτε στο χώρο του Υπουργείου (<a href="eksuphrethsh_epikoinwnia.php"><i class="icon-home">Σταδίου 29, Αθήνα</i></a>).</h6>
								</span>
              </div>
            </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <h3 class="heading">Κλείσιμο Ραντεβού</h3>
					</div>
				</div>
			</div>
			<div id="rantevou">
		...
		while($j<12){  
			...
			echo <<<_END
				...
				Εισάγετε το <strong>AMKA</strong> σας: <input type="text" name="amka" value="$amka" class="form-control" id="amka" placeholder="πχ. 25018202618" pattern="[0-9]{11}" title="Εισάγετε τα 11 ψηφία του ΑΜΚΑ σας" required />
