  ...
  <div id="wrapper">
          ...
          <div class="span12">
						<div class="headnav">
							<?php
								...
								if(isset($_SESSION['amka'])){
									$ulg = $_SESSION['amka'];
									echo <<<_END
										<form method="post" action="ergazomenos_sumptwmata.php">
										ΑΜΚΑ: $ulg &nbsp
            ...
            <div id="mySignup" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="ergazomenos_sumptwmata.php">
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown active"><a href="#">ΚΟΡΩΝΟΪΟΣ <i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            ...
                            <li class="active"><a href="ergazomenos_sumptwmata.php">ΣΥΝΑΔΕΛΦΟΣ ΜΕ ΣΥΜΠΤΩΜΑΤΑ</a></li>
          ...
          <div class="span12">
						<div class="cta floatleft">
							<ul class="breadcrumb">
								...
								<li class="active">Συνάδελφος με Συμπτώματα</li>
							</ul>
						</div>
          </div>
					<div class="span12" style="float: left; text-align: center">
						<div class="inner-heading">
							<h2>Συνάδελφος με Συμπτώματα</h2>
						</div>
					</div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h5><strong>Συνάδελφός</strong> εμφανίζει ξαφνικά κάποιο από τα <strong>συμπτώματα</strong> της νόσου <strong>εν ώρα εργασίας</strong>, όπως:</h5>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <h5 id="instructions">Στην περίπτωση αυτή, ακολουθείται η εξής <strong>διαδικασία:</strong></h5>
          </div>
        </div>

        <div class="row">
          <div class="span6 span-sm-12 text-left">
            <h5 class="symptoms-actions"><strong>1.</strong> Ειδοποιούμε <strong>άμεσα</strong> τον ιατρό εργασίας 
              και, στη συνεχεια, τον εργοδότη μας, ώστε
              να προβεί στις <a href="ergodoths_sumptwmata.php#instructions" target="_blank">προβλεπόμενες ενέργειες</a>.</h5>
          </div>
          <div class="span6">
            <div class="text-right">
							<img width="80%" height="50%" src="img/employee/employee1.png" title="Ειδοποιούμε τον εργοδότη" alt="Στηθοσκόπιο και λίστα ενεργειών.">
						</div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="span6 span-sm-12 text-left">
            <h5 class="symptoms-actions"><strong>2. </strong> Ο εργοδότης ενημερώνει τον ΕΟΔΥ, ο οποίος προχωρά στην 
              <strong>επιδημιολογική αξιολόγηση </strong>του κρούσματος ως ύποπτο ή επιβεβαιωμένο.</h5>
          </div>
          <div class="span6">
            <div class="text-right">
							<img width="80%" height="50%" src="img/employee/employee2.png" title="Επιδημιολογική αξιολόγηση" alt="Ιατρός εκτελει τεστ covid.">
						</div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="span6 span-sm-12 text-left">
            <h5 class="symptoms-actions"><strong>3.</strong> Ο ΕΟΔΥ πραγματοποιεί ιχνηλάτηση και θέτει  
             σε <strong>καραντίνα</strong> όσους κρίνει πως έχουν εκτεθεί στον κορωνοϊό.
          </div>
          <div class="span6">
            <div class="text-right">
							<img width="80%" height="50%" src="img/employee/employee3.png" title="Καραντίνα σε πιθανό κρούσμα" alt="Εικόνα ιού και δείγματος.">
						</div>
          </div>              
        </div>
            ...
            <div class="big-cta">
              <div class="cta-text">
                <span class="pullquote-left">
									<h6>Αν ανήκουμε στα άτομα που εκτέθηκαν στη λοίμωξη, θα χρειαστεί να παραμείνουμε σε καραντίνα
                    για διάστημα <strong>14 ημερών</strong>, τηρώντας υπεύθυνα τις οδηγίες που θα μας δώσει ο ΕΟΔΥ.
                   Ενημερώνουμε σχετικά τον εργοδότη ή τον προϊστάμενό μας.</h6>
								</span>
								<span class=" pullquote-right margintop10">
                  <h6>Ο ΕΟΔΥ <strong>κοινοποιεί</strong> στην επιχείρηση τα αποτέλεσματα της ιχνηλάτησης και μας εντάσσει
                    στη λίστα των ατόμων σε κατάσταση καραντίνας. Η δημόσια αρχή μπορεί ανά πάσα στιγμή να <strong>ελέγξει
                    </strong> τόσο <strong>εμάς</strong> όσο και <strong>τον εργοδότη</strong>
                     ως προς την τήρηση των μέτρων απομόνωσης.</h6>
								</span>
              </div>
            </div>
        </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <h4>Κατά το διάστημα της <strong>απομόνωσης</strong>, εφαρμόζουμε τους εξής κανόνες:</h4>
          </div>
        </div>
          ...
          <div class="span3">
            <div class="pricing-box-alt">
              <div class="pricing-heading">
                <img src="img/employee/at_home.png" alt="Άνθρωπος μέσα σε σπίτι.">
              </div>
              <div class="pricing-action">
                <div><strong>ΠΑΡΑΜΕΝΟΥΜΕ ΣΤΟ ΣΠΙΤΙ</strong></div>                
              </div>
            </div>
          </div>
          <div class="span3">
            <div class="pricing-box-alt">
              <div class="pricing-heading">
                <img src="img/employee/thermometer.png" title="" alt="Εικόνα με θερμόμετρο.">
              </div>
              <div class="pricing-action">
                <div><strong>ΘΕΡΜΟΜΕΤΡΟΥΜΑΣΤΕ ΤΑΚΤΙΚΑ</strong></div>
              </div>
            </div>
          </div>
          <div class="span3">
            <div class="pricing-box-alt">
              <div class="pricing-heading">
                <img src="img/employee/distances.png" title="" alt="Εικόνα με ασθενές και υγιές άτομο.">
              </div>
              <div class="pricing-action">
                <div><strong>ΤΗΡΟΥΜΕ ΦΥΣΙΚΕΣ ΑΠΟΣΤΑΣΕΙΣ</strong></div>
              </div>
            </div>
          </div>
          <div class="span3">
            <div class="pricing-box-alt">
              <div class="pricing-heading">
                <img src="img/employee/hands_wash.png" title="" alt="Χέρια που πλένονται.">
              </div>
              <div class="pricing-action">
                <div><strong> ΠΛΕΝΟΥΜΕ ΣΥΧΝΑ ΤΑ ΧΕΡΙΑ ΜΑΣ</strong></div>
              </div>
            </div>
          </div>          
        </div>  
      ...
      <div class="row">
        <div class="span3">
          <div class="pricing-box-alt">
            <div class="pricing-heading">
              <img src="img/employee/air.png" title="" alt="Εικόνα εξαερισμού.">
            </div>
            ...
            <div class="pricing-action">
              <div><strong>ΑΝΑΝΕΩΝΟΥΜΕ ΣΥΝΕΧΩΣ ΤΟΝ ΑΕΡΑ</strong></div>
            </div>
          </div>
        </div>
        <div class="span3">
          <div class="pricing-box-alt">
            <div class="pricing-heading">
              <img src="img/employee/clean.png" title="" alt="Εικόνα απολύμανσης με ψεκασμό.">
            </div>
            <div class="pricing-action">
              <div><strong>ΑΠΟΛΥΜΑΙΝΟΥΜΕ ΤΙΣ ΕΠΙΦΑΝΕΙΕΣ</strong></div>
            </div>
          </div>
        </div>
        <div class="span3">
          <div class="pricing-box-alt">
            <div class="pricing-heading">
              <img src="img/employee/clean_toilet.PNG" title="" alt="Εικόνα καθαρής τουαλέτας.">
            </div>
            <div class="pricing-action">
              <div><strong>ΚΑΘΑΡΙΖΟΥΜΕ ΣΥΧΝΑ ΤΗΝ ΤΟΥΑΛΕΤΑ</strong></div>
            </div>
          </div>
        </div>
        <div class="span3">
          <div class="pricing-box-alt">
            <div class="pricing-heading">
              <img src="img/employee/social.png" title="" alt="Εικόνα απαγόρευσης συναναστραφών.">
            </div>
            <div class="pricing-action">
              <div><strong>ΑΠΟΦΕΥΓΟΥΜΕ ΤΙΣ ΣΥΝΑΝΑΣΤΡΟΦΕΣ</strong></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="span12 text-left">
            <div class="big-cta">
              <div class="cta-text">
                <span class="pullquote-left">
                  <h6>Με την εμφάνιση <strong>οποιουδήποτε συμπτώματος</strong> αναπνευστικής λοίμωξης, καλούμε <strong>άμεσα</strong>
                     τον επαγγελματία υγείας που μας παρακολουθεί και επικοινωνούμε με τον <strong>ΕΟΔΥ</strong> στο
                     <i class="icon-phone">1135</i>.</h6>
								</span>
								<span class=" pullquote-right margintop10">
                  <h6><strong>Ενημερώνουμε τον εργοδότη μας</strong> για κάθε εξέλιξη της νόσου ή των συμπτωμάτων μας, αναφέροντας τις
                    νεότερες οδηγίες που μας δίνει κάθε φορά ο ΕΟΔΥ.</h6>
								</span>
              </div>
            </div>
        </div>
