...
<body>
  <div id="wrapper">
          ...
          <div class="span12">
						<div class="headnav">
							<?php
								...
								if(isset($_SESSION['amka'])){
									$ulg = $_SESSION['amka'];
									echo <<<_END
										<form method="post" action="eksuphrethsh_epikoinwnia.php">
										ΑΜΚΑ: $ulg &nbsp
            ...
            <div id="mySignup" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="eksuphrethsh_epikoinwnia.php">
                  ...
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="eksuphrethsh_epikoinwnia.php">ΕΠΙΚΟΙΝΩΝΙΑ</a></li>
                      </ul>
                    </li>
                  </ul>
                </nav>
    ...
    <section id="content">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3144.858924431888!2d23.728891014968315!3d37.9804215080747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a1bd3bad145a41%3A0x6db1fc0cbb58a00a!2zzqXPgM6_z4XPgc6zzrXOr86_IM6Vz4HOs86xz4POr86xz4IgzrrOsc65IM6azr_Ouc69z4nOvc65zrrPjs69IM6lz4DOv864zq3Pg861z4nOvQ!5e0!3m2!1sel!2sgr!4v1610603689717!5m2!1sel!2sgr" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
    </section>
		<section id="content">
      <div class="container">
        <div class="row">
          <div class="span5">
            <h3 class="heading"><i class="icon-home"></i> Διεύθυνση:</h3>
					</div>
					<div class="span7">
            <h3><strong>Σταδίου 29, Αθήνα 105 59 (Αττική)<strong></h3>
					</div>
				</div>
				<div class="row">
					<div class="span12">
				...
				<div class="row">
					<div class="span5">
						<h3 class="heading"><i class="icon-time"></i> Ωράριο Λειτουργίας:</h3>
					</div>
					<div class="span7">
						<h3><strong>8:30-14:30</strong></h3>
					</div>
				</div>
				<div class="row">
					<div class="span12">
				...
				<div class="row">
					<div class="span5">
						<h3 class="heading"><i class="icon-phone"></i> Τηλέφωνα Επικοινωνίας:</h3>
					</div>
					<div class="span3">
						<h3><strong>213-1516649</strong></h3>
					</div>
					<div class="span4">
						<h3><strong>213-1516651</strong></h3>
					</div>
				</div>
				<div class="row">
					<div class="span12">
				...
				<div class="row">
					<div class="span5">
						<h3 class="heading"><i class="icon-envelope-alt"></i> Ηλεκτρονικό Ταχυδρομείο:</h3>
					</div>
					<div class="span7">
						<h3><strong>pliroforisi_politi@ypakp.gr</strong></h3>
					</div>
				</div>
				<div class="row">
					<div class="span12">
				...
				<div class="row">
					<div class="span12">
						<h3 class="heading"><i class="icon-exclamation-sign"></i> Εξυπηρέτηση με <strong>φυσική παρουσία</strong> μόνο μετά από <a href="eksuphrethsh_fusikhParousia.php#rantevou">ραντεβού</a>!</h3>
					</div>
				</div>
			</div>
		</section>
