          ...
          <div class="span12">
						<div class="headnav">
							<?php
								...
								if(isset($_SESSION['amka'])){
									$ulg = $_SESSION['amka'];
									echo <<<_END
										<form method="post" action="ergazomenos_anastolh.php">
										ΑΜΚΑ: $ulg &nbsp
            ...
            <div id="mySignup" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="ergazomenos_anastolh.php">
                        ...
                        <li class="dropdown active"><a href="#">ΚΟΡΩΝΟΪΟΣ <i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            ...
                            <li><a href="ergazomenos_sumptwmata.php">ΣΥΝΑΔΕΛΦΟΣ ΜΕ ΣΥΜΠΤΩΜΑΤΑ</a></li>
														...
														<li class="active"><a href="ergazomenos_anastolh.php">ΑΝΑΣΤΟΛΗ ΣΥΜΒΑΣΗΣ ΕΡΓΑΣΙΑΣ</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="span12">
						...
						<img width="60%" height="20%" src="img/symptoms/anastolh3.jpg" title="Αναστολή σύμβασης εργασίας" alt="Εικόνα ρολογιού που το σταματάει ο κορωνοϊός.">
					</div>
				</div>
			</div>
		</section>
