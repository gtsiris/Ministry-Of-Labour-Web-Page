...
<body>
  <div id="wrapper">
          ...
          <div class="span12">
						<div class="headnav">
							<?php
								...
								if(isset($_SESSION['amka'])){
									$ulg = $_SESSION['amka'];
									echo <<<_END
										<form method="post" action="ergazomenos_metra.php">
										ΑΜΚΑ: $ulg &nbsp
            ...
            <div id="mySignup" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="ergazomenos_metra.php">
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown active"><a href="#">ΚΟΡΩΝΟΪΟΣ <i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            <li class="active"><a href="ergazomenos_metra.php">ΜΕΤΡΑ ΠΡΟΛΗΨΗΣ</a></li>
    ...
    <div class="text-center">
			<img width="100%" height="50%" src="img/symptoms/metra_hygiene.png" title="Μέτρα ατομικής υγιεινής για τον κορωνοϊό" alt="Εικόνα που γράφει μέτρα υγιεινής για τον κορωνοϊό.">
		</div>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h4>Ως <strong>εργαζόμενοι</strong> τηρούμε προληπτικά τις  
                  <span class="highlight"><strong><a href="#hygiene">γενικές οδηγίες ατομικής υγιεινής</a></strong></span>,
                  συμβάλλοντας στον έλεγχο της διασποράς του κορωνοϊου στους εργασιακούς χώρους.</h4>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <!--  Row 1 -->
        <div id="hygiene" class="row">
          <!-- <div class="span12">
            <h4>Φοράμε <strong>παντού</strong> και <strong>πάντα</strong> τη μάσκα προστασίας.</h4>
          </div> -->
          <div class="span3">
            <img src="img/employee/mask_wear.png" alt="Πρόσωπο με μάσκα" class="img-polaroid" />
            <div class="roles ">
              <p class="lead text-center">
                <strong>Φοράμε μάσκα</strong>
              </p>
              <p>
                Χρησιμοποιούμε <strong>πάντα</strong> και σε <strong>όλους τους χώρους</strong> τη μάσκα προστασίας.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/touch_mask.png" alt="Πρόσωπο και χέρια που δεν αγγίζουν μάσκα" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Δεν αγγίζουμε τη μάσκα</strong>
              </p>
              <p>
                Τοποθετούμε και βγάζουμε τη μάσκα πιάνοντας <strong>μόνο</strong> τα λάστιχά της.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/cough.png" alt="Πρόσωπο που βήχει στον αγκώνα" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Βήχουμε προσεκτικά</strong>
              </p>
              <p>
                <strong>Καλύπτουμε</strong> το στόμα και τη μύτη με τον αγκώνα κατά τον βήχα.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/sneeze.png" alt="Πρόσωπο που φυσάει τη μύτη" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Καλύπτουμε με μαντήλι</strong>
              </p>
              <p>
                Φέρουμε πάντα μαζί μας <strong>χαρτομάντηλο</strong> για το φύσημα της μύτης.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="span3">
            <img src="img/employee/throw_tissue.png" alt="Χέρι που πετάει σκουπίδια σε κάδο" class="img-polaroid" />
            <div class="roles ">
              <p class="lead text-center">
                <strong>Πετάμε τα απορρίματα</strong>
              </p>
              <p>
                Απορρίπτουμε <strong>αμέσως μετά τη χρήση</strong> τα χαρτομάντηλα σε <strong>σκεπαστό</strong> κάδο.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/hands_wash.png" alt="Πλύσιμο χεριών" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Πλένουμε τα χέρια μας</strong>
              </p>
              <p>
                <a href="https://youtu.be/3PmVJQUCm4E" target="_blank">Απολυμαίνουμε</a> <strong>τακτικά</strong> τα χέρια μας με σαπούνι και νερό ή αντισηπτικό διάλυμα.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/touch_face.png" alt="Χέρι που αγγίζει πρόσωπο" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Όχι χέρια στο πρόσωπο</strong>
              </p>
              <p>
                Προσπαθούμε να <strong>μην</strong> αγγίζουμε τα μάτια, τη μύτη και το στόμα μας με τα χέρια.
              </p>
            </div>
          </div>
          <div class="span3">
            <img src="img/employee/clean.png" alt="Χέρι που απολυμαίνει" class="img-polaroid" />
            <div class="roles">
              <p class="lead text-center">
                <strong>Απολυμαίνουμε τακτικά</strong>
              </p>
              <p>
                Καθαρίζουμε τις επιφάνειες με αραιωμένη χλωρίνη ή αντισηπτικό διάλυμα.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="span12">
			...
			<!-- Giorgos said: Insert your code here to implement your idea! :) -->
          ...
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                  ...
                  <h6>Επιδεικνύουμε την αναγκαία υπευθυνότητα αποφεύγοντας τον<strong> συγχρωτισμό</strong>,
                     τηρώντας <strong>ασφαλείς αποστάσεις</strong> από τους γύρω μας και φροντίζοντας για τη συνεχή <strong> 
                     ανανέωση του αέρα</strong> στον χώρο μας. Ακολουθούμε πιστά τα μέτρα τόσο κατά τη διάρκεια της εργασίας μας 
                     όσο και στην ιδιωτική μας ζωή.</h6>
								</span>
								<span class="pullquote-right">
									<h6>Ως εργαζόμενοι, συμβάλλουμε καθοριστικά στην πρόληψη για τον περιορισμό της επιδημίας. Ενημερωνόμαστε
                    για τα μέτρα που εφαρμόζει η επιχείρησή μας, καθώς και για κάθε εξέλιξη σχετικά με τον κορωνοϊό.
                     Είναι αναγκαία η συμμετοχή <strong>όλων </strong> για τη διασφάλιση της δημόσιας υγείας και την έξοδο από
                     αυτήν την κρίση</h6>
								</span>
							</div>
            </div>
